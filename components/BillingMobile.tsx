      ...
      <Dialog>
        <form>
          <DialogTrigger asChild>
            {/* <Button variant="outline" className="p-5 bg-[#A47251] text-white font-bold"></Button> */}
            <Button variant="outline" className="p-5 font-bold">
              <ShoppingCart />
                            ...
                            <div className="flex justify-between items-center">
                              <div className="w-20 flex justify-between items-center">
                                ...
                                <Button
                                  className="bg-[#A47251]"
                                  onClick={() =>
                                    addQuantity(item.id, item.category)
                                  }
                                >
                                  +
                                </Button>
